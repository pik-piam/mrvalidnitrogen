...
R package **mrvalidnitrogen**, version **1.6.3**
...
Bodirsky B (2021). _mrvalidnitrogen: madrat data preparation for validation purposes of nitrogen budgets_. R package version 1.6.3, <URL: https://github.com/pik-piam/mrvalidnitrogen>.
