...
R package **mrvalidnitrogen**, version **1.5.1**
...
Bodirsky B (2021). _mrvalidnitrogen: madrat data preparation for validation purposes of nitrogen budgets_. R package version 1.5.1, <URL: https://github.com/pik-piam/mrvalidnitrogen>.
